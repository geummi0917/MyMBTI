...
const qnaList = [
  ...
  const infoList = [
    {
      name: '연애 뭐 식은 죽 먹기죠!<br>연애 재능 만땅 <쥐>',
    ...
    {
      name: '이건 어때? 난 어때?<br>독특한 매력을 가진 <토끼>',
    ...
    {
      name: '<p>결혼은 언제쯤 할까? 신혼여행은 어디로?</p><p>이상적인 연애관의 소유자 <용></p>',
